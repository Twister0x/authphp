...
<body>
        ...
        <div class="carousel">
                ...
                <div class="slides">
                    <article class="main-post main-post--active">
                        ...
                        <div class="main-post__content">
                            ...
                            <h1 class="main-post__title">New McLaren wind tunnel 'critical' to future performance, says
                                Tech Director Key</h1>
            ...
            Verstappen" />
                        ...
                        <div class="main-post__content">
                            ...
                            <h1 class="main-post__title">Hamilton wants harder championship fight from Leclerc and
                                Verstappen
                            </h1>
                            <a class="main-post__link" href="#">
                                <span class="main-post__link-text">find out more</span>
            ...
            <div class="posts-wrapper hide-on-mobile">
                <article class="post post--active">
                    ...
                    <h2 class="post__title">New McLaren wind tunnel 'critical' to future performance, says Tech Director
                        Key</h2>
                </article>
                <article class="post">
                    <div class="progress-bar">
    ...
    <!-- инофрмация копмания -->
    <div class="Company__feautures">

    </div>
    <script src="../../../assets/pages/Home/js/carousel.js"></script>
</body>
